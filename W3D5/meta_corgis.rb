...
class MetaCorgiSnacks
  ...
  #     info_request = "get_#{method_name}_info".to_sym
  #     tastiness_request = "get_#{method_name}_tastiness".to_sym
  #     info = @snack_box.send(info_request ,@box_id)
  #     tastiness = @snack_box.send(tastiness_request ,@box_id)
  #     result = "Treat: #{info}: #{tastiness} "
  #     tastiness > 30 ? "* #{result}" : result
  #   else
  #     super
